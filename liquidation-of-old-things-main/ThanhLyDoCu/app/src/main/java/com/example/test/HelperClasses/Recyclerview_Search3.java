...
import com.example.test.User.MainUpdate;
import com.example.test.User.ProductDetail;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class Recyclerview_Search3 extends RecyclerView.Adapter<Recyclerview_Search3.ViewHolder> {
    @NonNull
    ...
    public Recyclerview_Search3(Context mcontext, ArrayList<Hinhanh> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mcontext, MainUpdate.class);
