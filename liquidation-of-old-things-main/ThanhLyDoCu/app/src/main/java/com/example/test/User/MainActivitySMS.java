...
Button send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sdt= findViewById(R.id.Mailsdt);
        noidung=findViewById(R.id.noidungsms);
    ...
    private void loadData(){
        ...
        noidung.setText(intent.getStringExtra("ten"));
    ...
    private void sendSMS_by_smsManager()  {
        ...
        String phoneNumber = this.sdt.getText().toString();
        String message = this.noidung.getText().toString();
