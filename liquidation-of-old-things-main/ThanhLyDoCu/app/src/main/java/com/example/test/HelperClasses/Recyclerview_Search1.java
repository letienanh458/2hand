...
public class Recyclerview_Search1 extends RecyclerView.Adapter<Recyclerview_Search1.ViewHolder> {
    @NonNull
    ...
    public Recyclerview_Search1(Context mcontext, ArrayList<Hinhanh> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.date.setText(filterList.get(position).getDate());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            date=itemView.findViewById(R.id.auction_time);
